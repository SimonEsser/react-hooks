...
test('can play a game of tic tac toe', async () => {
  ...
  expect(gameStart.textContent.includes('Current')).toBeTruthy()
  ...
  expect(gameStart.textContent.includes('Current')).toBeFalsy()
  expect(firstMove).toHaveAttribute('disabled')
  expect(firstMove.textContent.includes('Current')).toBeTruthy()
  ...
  expect(firstMove.textContent.includes('Current')).toBeFalsy()
  expect(secondMove).toHaveAttribute('disabled')
  expect(secondMove.textContent.includes('Current')).toBeTruthy()
  ...
  expect(secondMove.textContent.includes('Current')).toBeFalsy()
